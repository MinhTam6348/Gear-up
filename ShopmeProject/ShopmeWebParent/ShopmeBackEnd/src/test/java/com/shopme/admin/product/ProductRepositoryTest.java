...
public class ProductRepositoryTest {
	...
	public void testCreateProduct() {
		...
		product.setName("GU PAX");
		product.setAlias("powefull pc for gaming");
		product.setShortDescription("Short description for GU PAX");
		product.setFullDescription("Full description for GU PAX");
